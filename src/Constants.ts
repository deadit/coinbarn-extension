export default class Constants {
  ...
  public static termsURL: string = 'https://github.com/coinbarn/coinbarn-extension/blob/master/USER_AGREEMENT.md';

  public static privacyURL: string = 'https://github.com/coinbarn/coinbarn-extension/blob/master/PRIVACY.md';
